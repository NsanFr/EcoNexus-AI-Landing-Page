...
export default function About() {
  return (
    <section id="tentang" className="px-6 py-20 sm:py-24 md:py-32 bg-pattern-lines scroll-mt-20">
      <div className="mx-auto max-w-5xl">
        <AnimatedSection>
          <h2 className="font-sans text-2xl sm:text-3xl md:text-4xl font-semibold text-forest mb-8">
            Platform Iklim untuk Indonesia
          </h2>
        </AnimatedSection>
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 mb-12">
          <AnimatedSection delay={100}>
            <p className="text-forest/80 leading-relaxed text-base sm:text-lg mb-5 sm:mb-6">
            ...
            <p className="text-forest/70 leading-relaxed text-sm sm:text-base">
          ...
          <AnimatedSection delay={200}>
            <div className="bg-white rounded-md p-6 sm:p-8 border border-stone/50 shadow-sm">
              <h3 className="font-sans text-base sm:text-lg font-semibold text-forest mb-4 sm:mb-5">
                Kemampuan Inti
              </h3>
              <ul className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-forest/70 text-sm sm:text-base">
        ...
        <AnimatedSection delay={300}>
          <div className="bg-white rounded-md border border-stone/50 p-8 sm:p-10 shadow-sm">
            <h3 className="font-sans text-lg sm:text-xl font-semibold text-forest mb-8 sm:mb-10 text-center">
              Alur Data Platform
            </h3>
            <div className="flex flex-col md:flex-row items-center justify-between md:px-4 gap-6 md:gap-0">
              ...
              <div className="flex flex-col items-center text-center min-w-0">
                ...
                <span className="font-sans text-sm sm:text-base font-semibold text-forest">Satelit Global</span>
                <span className="text-xs sm:text-sm text-forest/50">NASA & Copernicus</span>
              </div>
              ...
              <div className="flex flex-col items-center text-center min-w-0">
                ...
                <span className="font-sans text-sm sm:text-base font-semibold text-forest">Data Lokal</span>
                <span className="text-xs sm:text-sm text-forest/50">BMKG, BRIN, BIG</span>
              </div>
              ...
              <div className="flex flex-col items-center text-center min-w-0">
                ...
                <span className="font-sans text-sm sm:text-base font-semibold text-forest">AI Processing</span>
                <span className="text-xs sm:text-sm text-forest/50">TensorFlow &lt; 5 menit</span>
              </div>
              ...
              <div className="flex flex-col items-center text-center min-w-0">
                ...
                <span className="font-sans text-sm sm:text-base font-semibold text-forest">Output</span>
                <span className="text-xs sm:text-sm text-forest/50">Dashboard & Notifikasi</span>
              </div>
            </div>
          </div>
        </AnimatedSection>
